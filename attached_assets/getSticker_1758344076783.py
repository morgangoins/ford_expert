...
for vin in vins:
    ...
    if response.status_code == 200:
        ...
        row = {}
        if 'topBlueLeft' in extracted_data and len(extracted_data['topBlueLeft']) >= 4:
            row['title'] = extracted_data['topBlueLeft'][0].strip()
            row['wheelbase'] = extracted_data['topBlueLeft'][1].strip()
            row['engine'] = extracted_data['topBlueLeft'][2].strip()
            row['transmission'] = extracted_data['topBlueLeft'][3].strip()
